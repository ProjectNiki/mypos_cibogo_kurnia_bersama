<section class="content-header">
	<h1>Add Customers <small>Customers</small></h1>
	<ol class="breadcrumb">
		<li>
				...
				<div class="col-md-6 col-md-offset-3">
					<form action="" method="POST">
						...
						<div class="input-group <?= form_error('pt_customers') == TRUE ? 'has-error' : null ?>">
							...
							<input type="text" name="pt_customers" id="pt_customers" class="form-control" placeholder="Nama PT" value="<?= set_value('pt_customers') ?>" autocomplete="off" autofocus="true">
						</div>
						...
						<div class="input-group <?= form_error('name_customers') == TRUE ? 'has-error' : null ?>">
							...
							<input type="text" name="name_customers" id="name_customers" class="form-control" placeholder="Nama Customers" value="<?= set_value('name_customers') ?>" autocomplete="off">
						</div>
						...
						<div class="input-group <?= form_error('phone_customers') == TRUE ? 'has-error' : null ?>">
							...
							<input type="number" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==13) return false;" name="phone_customers" id="phone_customers" value="<?= set_value('phone_customers') ?>" class="form-control" placeholder="No Tlp Customers" autocomplete="off">
						</div>
						...
						<div class="input-group <?= form_error('email_customers') == TRUE ? 'has-error' : null ?>">
							...
							<input type="text" id="email_customers" name="email_customers" class="form-control" value="<?= set_value('email_customers') ?>" placeholder="Email Customers" autocomplete="off">
						</div>
