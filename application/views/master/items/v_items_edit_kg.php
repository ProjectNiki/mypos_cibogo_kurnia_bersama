        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <form action="<?= site_url('items/process_edit_kg'); ?>" method="POST">
                        ...
                        <div>
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" id="qty_items_kg" name="qty_items_kg" class="form-control" placeholder="Kg" autocomplete="off" value="<?= $items->qty_items_kg ?>" required>
                            </div>
