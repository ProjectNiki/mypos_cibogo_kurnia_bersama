				...
				<div class="col-md-6 col-md-offset-3">
					<form action="<?= site_url('cash_in_and_out/proses_edit') ?>" method="POST">
						...
						<div class="form-group">
							...
							<input type="text" name="type_in" id="type_in" class="form-control" value="<?= $row->type ?>" readonly required>
						</div>
						<div class="form-group">
							<label for="nama">Nama <i class="text-danger">*</i></label>
							<input type="text" name="nama" id="nama" class="form-control" placeholder="Nama" value="<?= $row->pj ?>" autocomplete="off" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" onkeyup="splitInDots(this)" name="total_in" id="total_in" class="form-control" value="<?= indo_qty($row->total) ?>" placeholder="Total In" autocomplete="off" required>
						</div>
						<div class="form-group">
