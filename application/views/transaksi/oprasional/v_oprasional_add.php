				...
				<div class="col-md-6 col-md-offset-3">
					<form action="" method="POST">
						...
						<div class="input-group <?= form_error('fee_oprasional') == TRUE ? 'has-error' : null ?>">
							...
							<input type="text" onkeyup="splitInDots(this)" id="fee_oprasional" name="fee_oprasional" class="form-control" value="" placeholder="Fee" value="<?= set_value('fee_oprasional') ?>" autocomplete="off">
						</div>
						...
						<?php foreach ($row as $key => $data) { ?>
							<tr>
								...
								<td class="text-center">
									<button class="btn btn-success btn-sm" id="select" data-invoice="<?= $data->invoice ?>">
